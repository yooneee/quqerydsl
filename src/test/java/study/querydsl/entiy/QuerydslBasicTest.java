...
import static study.querydsl.entiy.QMember.*;
import static study.querydsl.entiy.QTeam.team;
...
public class QuerydslBasicTest {
    ...
    public void subQueryIn() throws Exception {
        ...
        List<MemberDto> result4 = em.createQuery(
    ...
    @Test
    public void findDtoByfieldsElias() {
        QMember memberSub = new QMember("memberSub");
    ...
    public void WhereParam() throws Exception{
        ...
        List<Member> reuslt = searchMember2(usernameParam, ageParam);
